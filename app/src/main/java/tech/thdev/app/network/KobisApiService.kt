...
interface KobisApiService {
    ...
    @GET(value = "kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=${BuildConfig.KOBIS_API_KEY}")
    ...
    @GET(value = "kobisopenapi/webservice/rest/boxoffice/searchWeeklyBoxOfficeList.json?key=${BuildConfig.KOBIS_API_KEY}")
